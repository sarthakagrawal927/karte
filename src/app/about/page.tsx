...
export const metadata: Metadata = {
  title: "About — Talix",
  description:
    "Talix is a link-in-bio that talks back. Chat, encyclopedia, roast, and newspaper modes powered by AI on top of your profile content.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-karte-text-2">
      ...
      <p className="mt-4 text-sm leading-6 text-karte-text-3">
        Talix is a link-in-bio with personality. Visitors don&apos;t
