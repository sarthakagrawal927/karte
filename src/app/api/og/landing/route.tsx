...
// Landing-page OG image. Mirrors the Onyx deck aesthetic — gold ink
// on warm-black, italic serif accents, foil hairline border — so the
// karte.cc unfurl in social previews matches the actual page.
//
// Satori (the renderer behind next/og) doesn't load Google Fonts at
// runtime, so we lean on system serif and let italic + tracking carry
// the brand feel. The deck's full Playfair Display rendering shows
// up the moment a visitor clicks through.
